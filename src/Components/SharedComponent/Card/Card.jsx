...
const Card = ({ contest }) => {
    const { _id, contestName, description, image, prize, price, endDate, taskInstructions, participant} =contest
    return (
        <div className="w-[320px] bg-slate-100 border-2 shadow-md rounded-lg">
            ...
            <div className="py-6 text-center px-6">
                ...
                <Link to={`/contest/${_id}`} state={{_id, contestName, description, image, prize, price, endDate, taskInstructions, participant}}><button className="bg-[#646cff] px-3 py-2 mt-4 font-semibold text-white text-base">Details</button></Link>
